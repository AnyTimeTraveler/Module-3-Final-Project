...
public class UniversalCommunicator implements IUserInterface {
    ...
    public void update(String msg) {
        if (selectedConversation != null)
            chatHistoryTextArea.setText(Arrays.stream(selectedConversation.getChatHistory()).map(message -> chatClient.getUserById(message.getSender()).getName() + " : " + message.getMessage()).collect(Collectors.joining("\n")));
    ...
    public void setup(IChatController chatClient, NetworkStack networkStack) {
        ...
        fileTransferSendButton.addActionListener(e -> {
            new FileTransferer(this, selectedFile, fileTransferUserList.getSelectedValue().getAddress());
        });
    ...
    public void setProgress(int current, int max) {
        ...
        fileTransferProgressBar.setValue((int) current);
    }
