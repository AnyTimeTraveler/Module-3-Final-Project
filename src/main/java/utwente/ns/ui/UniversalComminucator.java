...
public class UniversalComminucator implements IUserInterface {
    ...
    public void setup(IChatController chatClient) {
    ...
    private void createUIComponents() {
        ...
        System.out.println("Custom create called!");
    }
    ...
    private void $$$setupUI$$$() {
        ...
        panel6.add(fileTransferFileButton,
                   new GridConstraints(0,
                                       0,
                                       1,
                                       1,
        ...
        panel6.add(fileTransferSendButton,
                   new GridConstraints(2,
                                       0,
                                       1,
                                       1,
        ...
        panel6.add(fileTransferReceiveButton,
                   new GridConstraints(1,
                                       0,
                                       1,
                                       1,
        ...
        panel5.add(fileTransferLogTextArea,
                   new GridConstraints(2,
                                       0,
                                       1,
                                       1,
        ...
        panel4.add(fileTransferProgressBar,
                   new GridConstraints(1,
                                       0,
                                       1,
                                       1,
        ...
        panel10.add(settingsSaveButton,
                    new GridConstraints(0,
                                        1,
                                        1,
                                        1,
