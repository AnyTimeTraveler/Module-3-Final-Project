...
public class UserListDialogue extends JDialog {
    ...
    private LinkedBlockingQueue<List<IUser>> selectionQueue;

    public UserListDialogue(IUser[] users, boolean singleSelect, LinkedBlockingQueue<List<IUser>> selectionQueue) {
